...
fascinating woman. An appreciative listener is always stimulating, and \
...
to warn you, whether you like it or not. That man would as soon murder \
...
and pay a visit to Cynthia in her dispensary. Mrs. Inglethorp replied \
...
household was aroused by now. The most alarming sounds were audible from \
the interior of the room. Clearly something must be done. \
 \
...
room. It was pitch dark, but Lawrence was following with the candle, and \
by its feeble light we saw that the bed had not been slept in, and that \
there was no sign of the room having been occupied. \
 \
We went straight to the connecting door. That, too, was locked or bolted \
on the inside. What was to be done? \
 \
...
beneath our weight, and finally, with a resounding crash, it was burst \
open. \
 \
...
my lips. Never have I seen such a ghastly look on any man's face. He was \
...
wall. It was as though he had seen something that turned him to stone. \
I instinctively followed the direction of his eyes, but I could see \
nothing unusual. The still feebly flickering ashes in the grate, and the \
row of prim ornaments on the mantelpiece, were surely harmless enough. \
 \
...
voice. She herself, I noticed, was dressed in her white land smock. Then \
it must be later than I thought. I saw that a faint streak of daylight \
...
to behold. Everything was confusion. We thronged round her, powerless to \
...
and relocked it, and slipped the bunch of keys, as well as the key that \
...
\"And the sixth point?\" I asked. \"I suppose it is the sample of coco.\" \
 \
\"No,\" said Poirot thoughtfully. \"I might have included that in the \
six, but I did not. No, the sixth point I will keep to myself for the \
present.\" \
 \
...
case, with the same methodical care that he bestowed on everything. \
My brain was in a whirl. What was this complication of a will? Who had \
...
bolted on the inside. \
 \
\"Now, my friend,\" said Poirot briskly, \"we will go. I should like to ask \
a few questions of the parlourmaid--Dorcas, her name is, is it not?\" \
 \
...
We went out through that door, locking both it and that of Mrs. \
...
\"About six o'clock, sir.\" \
 \
\"Thank you, Dorcas, that is all I have to ask you.\" He rose and strolled \
...
to Mr. Wells, the lawyer, and the other two I don't think I remember, \
...
his normal self. The shock of the events of the last night had upset him \
temporarily, but his equable poise soon swung back to the normal. He was \
a man of very little imagination, in sharp contrast with his brother, \
...
find it. If Mr. Inglethorp did take it, he has had ample time to replace \
it by now.\" \
 \
\"But do you think----\" \
 \
...
is not against professional etiquette. In the event of Mrs. Inglethorp's \
death, who would inherit her money?\" \
 \
...
last will, dated August of last year, after various unimportant legacies \
...
her money to her elder stepson, knowing that he would have to keep up \
Styles. It was, to my mind, a very fair and equitable distribution.\" \
 \
Poirot nodded thoughtfully. \
 \
...
\"Yet you seem to be invariably charming to Dr. Bauerstein!\" \
 \
Instantly I regretted my words. Her face stiffened. I had the impression \
of a steel curtain coming down and blotting out the real woman. Without \
a word, she turned and went swiftly up the stairs, whilst I stood like \
an idiot gaping after her. \
 \
I was recalled to other matters by a frightful row going on below. I \
could hear Poirot shouting and expounding. I was vexed to think that \
my diplomacy had been in vain. The little man appeared to be taking \
the whole house into his confidence, a proceeding of which I, for one, \
...
much given to these fantastic ideas. In this case, surely, the truth was \
...
\"He says not.\" \
 \
\"One might take that with a grain of salt,\" I remarked sceptically. \"All \
these wills are very confusing. Tell me, how did those scribbled words \
on the envelope help you to discover that a will was made yesterday \
afternoon?\" \
 \
Poirot smiled. \
 \
...
cumulative effect of a drug, administered for some time, has ended \
by causing death. Also, is it not possible that she may have taken an \
...
this way. There would have to be a long period of chronic symptoms which \
would at once have attracted my attention. The whole thing is absurd.\" \
 \
...
proceeded with his task. Having elicited from Dorcas how she had \
been awakened by the violent ringing of her mistress's bell, and had \
...
one stray word or phrase to make you realize that it _was_ a private \
conversation?\" \
 \
...
from the young man's lips. I half thought he was going to rise from \
...
Murder against him right off. I think they would have, if it hadn't been \
for the Coroner--he seemed to be holding them back.\" \
 \
...
nod--from you. You've been on the spot--and the Yard doesn't want to \
...
against him will be dismissed at once! Comme ca!\" And he snapped his \
...
Poirot reflected a moment. \
 \
\"It can be done,\" he said at last. \"I admit I do not wish it. It \
forces my hand. I would have preferred to work in the dark just for the \
...
much obliged to you, though I'm bound to confess I can't at present see \
...
discreditable behind his silence. If he did not murder his wife, he \
is, nevertheless, a scoundrel, and has something of his own to conceal, \
...
strenuously the theory of death from natural causes. If it had \
...
Hercule Poirot, affirm that the man who entered the chemist's shop, \
...
at six or just after and, as you may know, the Abbey Farm, Mrs. Raikes's \
home, is at least two and a half miles distant from the village. There \
...
These witnesses of yours are all right, I suppose?\" \
 \
\"Voila! I have prepared a list of them--names and addresses. You must \
...
rumour----\" \
 \
\"A most malicious and utterly untrue one,\" interrupted Alfred Inglethorp \
...
of rumours than be arrested for murder. And I venture to think your poor \
lady would have felt the same. And, if it hadn't been for Mr. Poirot \
here, arrested you would have been, as sure as eggs is eggs!\" \
 \
...
in some way, Mrs. Inglethorp got hold of it by mistake. But I don't \
...
\"Why, she was devoted to her!\" I exclaimed. \
 \
\"Tcha! Tcha!\" cried Poirot irritably. \"You argue like a child. If \
Miss Howard were capable of poisoning the old lady, she would be quite \
...
in the deduction you draw from it. I have drawn my own deductions, which \
I believe to be correct, but I will not speak of them at present.\" He \
paused a minute, then went on. \"Now, to my way of thinking, there is one \
...
feeling that one ought to make amends; which is difficult, when one \
...
\"No. I--never looked.\" \
 \
\"But I did,\" interrupted Lawrence suddenly. \"I happened to notice that \
it _was_ bolted.\" \
 \
\"Ah, that settles it.\" And Poirot looked crestfallen. \
 \
I could not help rejoicing that, for once, one of his \"little ideas\" had \
come to naught. \
 \
...
We had reached the cottage. \
 \
\"No. I think I'll be getting back. I shall go round the long way through \
the woods.\" \
 \
...
and subdued. I strolled on a little way, and finally flung myself down \
at the foot of a grand old beech-tree. My thoughts of mankind were \
...
I yawned again. \
 \
Probably, I thought, it really never happened. Of course, it was all \
a bad dream. The truth of the matter was that it was Lawrence who had \
...
twelve feet away from me, John and Mary Cavendish were standing \
...
dragged him into the room. \"I was never so glad to see anyone. Listen, I \
have said nothing to anybody but John. Is that right?\" \
 \
...
for a minute or two. \"It certainly isn't a J.\" \
 \
\"Good,\" replied Poirot, folding up the paper again. \"I, also, am of your \
way of thinking. It is an L., depend upon it!\" \
 \
...
and cardboard boxes. I have kept them there myself. Neatly arranged, \
...
sudden energy, he caught me by the arm, and whirled me down the \
hall, calling out in French in his excitement: \"Mademoiselle Dorcas, \
...
or John. Now, if it was Lawrence, Mary Cavendish's conduct was just as \
...
for the prosecution, but in all probability his solicitors will advise \
him to reserve his defence. That will be sprung upon us at the trial. \
And--ah, by the way, I have a word of caution to give you, my friend. I \
must not appear in the case.\" \
 \
\"What?\" \
 \
...
and we must use any means in our power--otherwise he will slip \
...
That \"last link\" he talked about was still lacking. Privately, I hoped \
it might remain so, for what happiness could there be for Mary, if John \
were not acquitted? \
 \
...
\"That is better.\" \
 \
An assistant from Parkson's, Theatrical Costumiers, testified that \
on June 29th, they had supplied a black beard to Mr. L. Cavendish, as \
requested. It was ordered by letter, and a postal order was enclosed. \
No, they had not kept the letter. All transactions were entered in their \
books. They had sent the beard, as directed, to \"L. Cavendish, Esq., \
Styles Court.\" \
 \
...
reopened, and gave his evidence succinctly and briefly. After relating \
...
to his intrigue with Mrs. Raikes--poor Mary, that must have been bitter \
...
it and his financial embarrassments had been grossly exaggerated. \
 \
...
shop in Styles St. Mary, where you purchased strychnine in the name of \
Alfred Inglethorp?\" \
 \
\"No, that is a lie.\" \
 \
...
said Mr. Philips, and sat down with the air of a man who has done his \
duty, but who was nevertheless horrified by such deliberate perjury. \
 \
...
occasion a complete revolution of feeling, since she is now as anxious \
...
suitable for disguising the taste of strychnine that it is extraordinary \
...
afraid of the scandal, as no possible scandal could attach to him. This \
...
Miss Howard will have engineered her quarrel, and departed from the \
...
conceived crime. If all had gone as they planned, they would probably \
...
directed against him, she would be making quiet preparations for a \
...
of pure accident. It must, in fact, have been distinctly annoying to the \
pair of schemers.\" \
 \
...
asked Mr. Wells that first question about the will. Then there were \
...
\"You are joking, Poirot!\" \
 \
\"No. Shall I tell you what made Monsieur Lawrence turn so pale when \
he first entered his mother's room on the fatal night? It was because, \
...
the real criminals. They were entirely in the dark as to my real \
...
could have brought these two proud souls together again.\" \
 \
I looked at Poirot in silent amazement. The colossal cheek of the little \
man! Who on earth but Poirot would have thought of a trial for murder as \
a restorer of conjugal happiness! \
 \
...
he said. \"I have brought him back to you.\" He had stood aside, and as \
I went out I had seen the look in Mary's eyes, as John Cavendish had \
...
Console yourself, my friend. We may hunt together again, who knows? And \
then----\" \
 \
 \
THE END \
