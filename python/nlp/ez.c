...
/* Python wrapper */
static PyObject *__pyx_pw_3nlp_2ez_3sent_tokenize(PyObject *__pyx_self, PyObject *__pyx_v_str_or_unicode); /*proto*/
static PyMethodDef __pyx_mdef_3nlp_2ez_3sent_tokenize = {"sent_tokenize", (PyCFunction)__pyx_pw_3nlp_2ez_3sent_tokenize, METH_O, 0};
static PyObject *__pyx_pw_3nlp_2ez_3sent_tokenize(PyObject *__pyx_self, PyObject *__pyx_v_str_or_unicode) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("sent_tokenize (wrapper)", 0);
  __pyx_r = __pyx_pf_3nlp_2ez_2sent_tokenize(__pyx_self, ((PyObject *)__pyx_v_str_or_unicode));
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("nlp.ez.sent_tokenize", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_buf);
  __Pyx_XDECREF((PyObject *)__pyx_v_doc);
...
#endif
{
  ...
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  __pyx_ptype_3nlp_6libnlp_MemoryManagerWrapper = __Pyx_ImportType("nlp.libnlp", "MemoryManagerWrapper", sizeof(struct __pyx_obj_3nlp_6libnlp_MemoryManagerWrapper), 1); if (unlikely(!__pyx_ptype_3nlp_6libnlp_MemoryManagerWrapper)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_3nlp_6libnlp_PTBTokenizerConfigWrapper = __Pyx_ImportType("nlp.libnlp", "PTBTokenizerConfigWrapper", sizeof(struct __pyx_obj_3nlp_6libnlp_PTBTokenizerConfigWrapper), 1); if (unlikely(!__pyx_ptype_3nlp_6libnlp_PTBTokenizerConfigWrapper)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_3nlp_6libnlp_BufferDocument = __Pyx_ImportType("nlp.libnlp", "BufferDocument", sizeof(struct __pyx_obj_3nlp_6libnlp_BufferDocument), 1); if (unlikely(!__pyx_ptype_3nlp_6libnlp_BufferDocument)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_3nlp_6libnlp_BufferToken = __Pyx_ImportType("nlp.libnlp", "BufferToken", sizeof(struct __pyx_obj_3nlp_6libnlp_BufferToken), 1); if (unlikely(!__pyx_ptype_3nlp_6libnlp_BufferToken)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 106; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_3nlp_6libnlp_SentenceView = __Pyx_ImportType("nlp.libnlp", "SentenceView", sizeof(struct __pyx_obj_3nlp_6libnlp_SentenceView), 1); if (unlikely(!__pyx_ptype_3nlp_6libnlp_SentenceView)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     global memmgr
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_3nlp_2ez_1tokenize, NULL, __pyx_n_s_nlp_ez); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
